...
_1.  In coin tossing, assuming it is a fair coin, what is the expected toss of the event that a head comes before a tail?
...
_2.  In a similar manner, we have an fair coin, what is the expected toss of the event that two heads comes consecutively?
