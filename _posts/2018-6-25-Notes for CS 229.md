...
This is the same as the primal problem if all constrain are satisfied. We define the value of primal problem to be: $p^{\star} = \min_w \theta_{\mathcal{P}(w)$. Then, we define:
