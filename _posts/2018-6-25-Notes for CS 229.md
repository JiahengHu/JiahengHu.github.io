...
$$\max_{\gamma,w,b} \gamma \text{s.t.}$$

$$y^{(i)}(w^Tx^{(i)} + b) \geq \gamma, i = 1,\dots,m$$
...
$$\max_{\overset{\wedge}{\gamma},w,b} \frac{\overset{\wedge}{\gamma}}{\lvert\lvert w \rvert\rvert} \text{s.t.}$$

$$y^{(i)}(w^Tx^{(i)} + b) \geq \overset{\wedge}{\gamma}, i = 1,\dots,m$$
...
$$\min_{\gamma,w,b} \frac{1}{2} \lvert\lvert w \rvert\rvert^2 \text{s.t.}$$
