...
This means that for a particular $h_i$ with high probablity the training error will be close to generalization error. which is nice. The more valueable point is to prive this is true for all $h\in\mathcal{H}$. 
