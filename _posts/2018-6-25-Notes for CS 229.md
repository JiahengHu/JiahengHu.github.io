...
When the target output is in continuous space, we call it a regression problem. When the target output is in discrete space, we call is a classification problem. 
